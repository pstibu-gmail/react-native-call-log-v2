...
public class CallLogV2Module extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void loadAllByType(String type, Promise promise) {
        loadByType(-1, type, promise);
    }
    ...
    @ReactMethod
    public void loadByType(int limit, String type, Promise promise) {
        loadByTypeWithFilter(limit, type, null, promise);
    }
    ...
    @ReactMethod
    public void loadByTypeWithFilter(int limit, String call_type, @Nullable ReadableMap filter, Promise promise) {
        try {
            Cursor cursor = this.context.getContentResolver().query(CallLog.Calls.CONTENT_URI,
                    null, null, null, CallLog.Calls.DATE + " DESC");
